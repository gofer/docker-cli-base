...
RUN apk add fontconfig-dev freetype-dev harfbuzz-dev libxcb-dev \
            fontconfig-static freetype-static harfbuzz-static libxcb-static \
            expat-static bzip2-static libpng-static zlib-static graphite2-static \
 && RUSTFLAGS='-Clink-arg=-lexpat -Clink-arg=-lbz2 -Clink-arg=-lpng -Clink-arg=-lz -Clink-arg=-lgraphite2 -Clink-arg=-lXau -Clink-arg=-lXdmcp -Clink-arg=-lbrotlidec' \
